		...
		<section class="py-5">
			<div class="container">
				...
				<form action="SearchServlet" method="post">
					<div class="row">
						<p class="col-md-1 form-group">注文日付</p>
						<p class="col-md-2 form-group">
						...
						<div class="col-md-1 form-group"></div>
						<p class="col-md-1 form-group">支払方法</p>
						...
						<div class="col-md-2 form-group">
							...
							<button class="btn btn-primary" type="button"
								onclick="clearText()" style="font-size: 12px">検索条件クリア</button>
						</div>
						<div class="col-md-12" style="text-align: center;">
							<!-- ボタン押下時に入力内容をサーブレットへ送信 -->
							<button class="btn btn-primary" type="submit"
								style="font-size: 12px">検索</button>
						</div>
					</div>
				</form>
			</div>
